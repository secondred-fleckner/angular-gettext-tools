...
var Extractor = (function () {
    ...
    Extractor.prototype.extractJson = function (filename, src, lineNumber) {
        // used for line number
        var self = this,
            additionalSnippets = JSON.parse(src);

        additionalSnippets.forEach(function(snippet, index) {
            self.addString(filename + ':' + index, snippet);
        });
    };
